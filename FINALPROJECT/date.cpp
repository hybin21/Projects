 ...
 *_________________________________________________________________
 *  description: this method returns the day value
 *
 ...
 *
 * POSTCONDITIONS:
 *  the program returns day value
 *
********************************************************************************/
unsigned Date::returnDay()const
{
    return day;
}
 ...
 *_________________________________________________________________
 *  description: this method returns the month value
 *
 ...
 *
 * POSTCONDITIONS:
 *  the program returns month value
 *
********************************************************************************/
unsigned Date::returnMonth() const
{
    return month;
}
 ...
 *_________________________________________________________________
 *  description: this method returns the year value
 *
 ...
 *
 * POSTCONDITIONS:
 *  the program returns year value
 *
********************************************************************************/
unsigned Date::returnYear() const
{
    return year;
}
 ...
 *_________________________________________________________________
 * PRECONDITIONS:
 *   const int month: input month
 *   const int day: input day
 *   const int year: input year
 *
 * POSTCONDITIONS:
 *  the program sets new value
 *
********************************************************************************/
void Date::setValue(const int month,    // IN - input month
                    const int day,  // IN - input day
                    const int year) // IN - inptu year
{
    this->month = month;
    this->day = day;
    this->year = year;
 ...
 * operator>=: Class Date
 *_________________________________________________________________
 * Overloads the >= operator so it checks if the Date
 ...
 *   const Date &input: Date variable to be compared
 *
 * POSTCONDITIONS:
 ...
 *
*******************************************************************************/
 bool Date::operator>=(const Date& input)   // IN - input object
 {
    if(this->year >= input.year)
        return true;
    else if(this->month >= input.month)
        return true;
    else if(this->day >= input.day)
        return true;
    else
        return false;
 }
 ...
 *******************************************************************************/
   ...
   * - returns true/false if the Date number is equal
   *         to the input
   *_________________________________________________________________
   * PRECONDITIONS:
   *  The following needs previous defined values:
  ...
  *******************************************************************************/
   ...
   * operator==: Class Date
   *_________________________________________________________________
   * Overloads the == operator so it checks if the Dates are equal
   ...
   *
   * POSTCONDITIONS:
   *  Overloads the == operator so that compares the Date variables
   *
  *******************************************************************************/
  bool Date::operator==(const Date& input)  // IN - input object
  {
      if(this->year == input.year && this->month == input.month && this->day== input.day)
          return true;
      else
          return false;
  }
