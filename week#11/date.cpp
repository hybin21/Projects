 ...
 *
 * POSTCONDITIONS:
 *  initializes the date to the newDate's date
 *
*******************************************************************************/
Date::Date(const Date & newDate)    // IN - newDate to be copied
{
    this->month = newDate.month;
    this->day = newDate.day;
    this->year = newDate.year;
    this->monthName = newDate.monthName;
}
 ...
 *_________________________________________________________________
 *  description: function overloads the operator =
 *               
 *  - returns the Date object
 *_________________________________________________________________
 * PRECONDITIONS:
 *   Date newDate: Date object should be declared
 *   
 *
 * POSTCONDITIONS:
 *  newDate's data is copied to the object
 *
*******************************************************************************/
Date & Date::operator=(const Date & newDate)    // IN - Date to be copied
{
    this->month = newDate.month;
    this->day = newDate.day;
    this->year = newDate.year;
